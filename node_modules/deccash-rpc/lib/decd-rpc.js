...
class Decd {
   ...
   * @param {string} [opts.userAgent=deccash-rpc/version] - the user agent string to use with requests
   * @param {boolean} [opts.keepAlive=true] - whether the underlying HTTP(s) connection should be kept alive and reused
   */
  constructor (opts) {
    opts = opts || {}
    this.host = opts.host || '127.0.0.1'
    this.port = opts.port || 28287
   ...
   * @property {Decd.TransactionSummary[]} transactions
   ...
   * @returns {Promise<Decd.BlockSummary>} resolves with block summary or rejects with error
   */
  block (hash) {
   ...
   * @async
   * @param {string} hash - the hash of the block to retrieve
   * @returns {Promise<Decd.BlockHeader>} resolves with block header or rejects with error
   */
   ...
   * @async
   * @param {number} height - the height of the block to retrieve
   * @returns {Promise<Decd.BlockShortHeader[]>} resolves with block short headers or rejects with error
   */
   ...
   * @property {Decd.TransactionDetailInputCoinbaseInput} input - the input
   */
   ...
   * @property {Decd.TransactionDetailInputKeyInput} input - the input
   * @property {number} mixin - the ring size
   * @property {Decd.TransactionDetailInputKeyOutput} output - the related output information
   */
   ...
   * @property {Decd.TransactionDetailInputCoinbase|Decd.TransactionDetailInputKey} data - the input data
   ...
   * @property {Decd.TransactionOutputTargetData} data - output data structure
   ...
   * @property {Decd.TransactionOutputTarget} target - the output target
   */
   ...
   * @property {Decd.TransactionOutput} output - The transaction output
   */
   ...
   * @property {Decd.TransactionExtraDetail} extra - the transaction extra
   ...
   * @property {Decd.TransactionDetailInput[]} inputs - the inputs of the transaction
   * @property {number} mixin - the number of transaction mixins
   * @property {Decd.TransactionDetailOutput[]} outputs - the outputs of the transaction
   ...
   * @property {number} timestamp - the block timestamp
   * @property {number} totalFeeAmount - the total amount of fees in the block
   * @property {Decd.TransactionDetail[]} transactions
   * @property {number} transactionsCumulativeSize - the total size of the transactions in the block
   */
   ...
   * @property {Decd.BlockDetails} blocks - the blocks
   ...
   * @returns {Promise<Decd.BlocksDetailedResponse>} resolves with blocks detail information or rejects with error
   */
  blocksDetailed (opts) {
    opts = opts || {}
   ...
   * @property {string} hash - the block hash
   * @property {Decd.TransactionPrefix[]} transactions - the transactions in the block
   */
   ...
   * @property {Decd.BlockLite[]} items - the block data
   ...
   * @param {number} [opts.timestamp=0] - the timestamp to start from
   * @param {string[]} [opts.blockHashes] - the block hashes
   * @returns {Promise<Decd.BlocksLiteResponse>} resolves with block information or rejects with error
   */
  blocksLite (opts) {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) throw new Error('must supply an array of block hashes')
   ...
   * @returns {Promise<Decd.BlockTemplateResponse>} resolves with block template response or rejects with error
   */
   ...
   * @async
   * @returns {Promise<Decd.NodeFee>} resolves with node fee information or rejects with error
   */
  fee () {
   ...
   * @returns {Promise<Decd.GlobalIndexesResponse[]>} resolves with global indexes information or rejects with error
   */
   ...
   * @async
   * @returns {Promise<Decd.NodeHeight>} resolves with node height information or rejects with error
   */
  height () {
   ...
   * @async
   * @returns {Promise<Decd.NodeInfo>} resolves with node information or rejects with error
   */
  info () {
   ...
   * @async
   * @returns {Promise<Decd.NodePeers>} resolves with node peer information or rejects with error
   */
  peers () {
   ...
   * @property {string} hash - the transaction hash
   * @property {Decd.TransactionPrefix} prefix - the transaction prefix
   */

  /**
   * @memberof Decd
   * @typedef PoolChanges
   * @property {Decd.PoolChangesAdded} addedTxs - the recently added pool transactions
   ...
   * @returns {Promise<Decd.PoolChanges>} resolves with pool change information or rejects with error
   */
   ...
   * @property {number} amount - the amount of the output
   * @property {Decd.RandomOutput[]} outs - a list of random outputs
   */
   ...
   * @property {Decd.RandomOuts[]} outs - a list of random outs
   * @property {string} status - the response status
   */
   ...
   * @returns {Promise<Decd.RandomOutputsResponse>} resolves with random outputs information or rejects with error
   */
   ...
   * @property {Decd.RawTransaction[]} transactions - a list of raw transactions
   * @property {number} tx_count - the number of transactions in the block
   */
   ...
   * @property {Decd.RawBlock[]} blocks - the raw blocks
   ...
   * @returns {Promise<Decd.RawBlocksResponse>} resolves with raw blocks information or rejects with error
   */
   ...
   * @returns {Promise<Decd.SendRawTransactionResponse>} resolves with send raw transaction information or rejects with error
   */
   ...
   * @returns {Promise<Decd.SubmitBlockResponse>} resolves with submit block response or rejects with error
   */
   ...
   * @memberof Decd
   * @typedef VOUTTarget
   * @property {Decd.VOUTTargetData} data - output target data
   ...
   * @typedef VOUT
   * @property {number} amount - the amount of the output
   * @property {Decd.VOUTTarget} target - the output target
   */
   ...
   * @property {Decd.VINCoinbase|Decd.VIN[]} vin - the transaction inputs
   * @property {Decd.VOUT[]} vout - the transaction outputs
   */
   ...
   * @property {string} status - the status of the request
   * @property {Decd.TransactionPrefix} tx - the transaction structured information
   * @property {Decd.TransactionMetadata} txDetails - the transaction meta information
   */
   ...
   * @returns {Promise<Decd.TransactionResponse>} resolves with transaction response or rejects with error
   */
  transaction (hash) {
    if (!hash) throw new Error('must specify hash')
   ...
   * @async
   * @returns {Promise<Decd.TransactionSummary[]>} resolves with the transaction summaries or rejects with error
   */
  transactionPool () {
   ...
   * @returns {Promise<Decd.TransactionsStatusResponse>} resolves with the transactions statuses or rejects with error
   */
   ...
   * @property {string} hash - the transaction hash
   * @property {Decd.TransactionDetailInputKeyInput} [inputs] - the transaction inputs
   * @property {Decd.WalletSyncTransactionOutput[]} outputs - the transaction outputs
   ...
   * @property {Decd.WalletSyncTransaction} [coinbaseTX] - the block coinbase transaction
   * @property {Decd.WalletSyncTransaction[]} transactions - the transactions in the block
   */
   ...
   * @property {Decd.WalletSyncDataBlock[]} items - block data array
   * @property {string} status - the reponse status message
   * @property {boolean} synced - whether the request is fully synched
   * @property {Decd.WalletSyncDataTopBlock} [topBlock] - the top block information
   */
   ...
   * @returns {Promise<Decd.WalletSyncDataResponse>} resolves with sync data response or rejects with error
   */
  walletSyncData (opts) {
    opts = opts || {}
